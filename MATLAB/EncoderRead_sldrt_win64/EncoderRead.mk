...
MODEL                := EncoderRead
MODULES              := EncoderRead_data.c EncoderRead_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := EncoderRead.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := EncoderRead_ref.rsp
